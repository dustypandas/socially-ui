...
export const sampleCommunityPage = {
  id: 'polylogue-madrid',
  name: 'Polylogue Madrid: share • learn • inspire',
  image: './assets/community-polylogue.avif',
  memberCount: 841,
  ...
  organizers: [
    { name: 'Achi J', image: './assets/member-achi.avif' },
    { name: 'Peter C', image: './assets/member-peter.webp' },
    { name: 'Maria M', image: './assets/member-maria.jpg' },
  ],
  memberProfiles: memberAvatarUrls.map((image, index) => ({
    name: memberFollowers[index]?.name ?? `Member ${index + 1}`,
    image,
  })),
  upcomingEvents: [
    {
