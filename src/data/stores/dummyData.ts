...
const COMMUNITY_EVENT_LOCATIONS: MapLocation[] = [
  { label: 'Palacio', lat: 40.4155, lng: -3.7141 },
  { label: 'Malasaña', lat: 40.4267, lng: -3.7037 },
  { label: 'Chueca', lat: 40.4227, lng: -3.6978 },
  { label: 'Retiro', lat: 40.4153, lng: -3.6844 },
];

function createCommunityLightningEvent(
  idSuffix: string,
  daysFromNow: number,
  attendeeSeed: number,
  ...
  return {
    id: `polylogue-lightning-${idSuffix}`,
    title: 'Lightning Talks @ Maria Pandora',
    image: './assets/dummy-data/event-lightning.avif',
    href: '#/one-event-ui',
    startTime: getTimestampFromNow(daysFromNow, 19, 10),
    location: COMMUNITY_EVENT_LOCATIONS[locationIndex % COMMUNITY_EVENT_LOCATIONS.length],
    attendees: getDynamicAttendees(40 + (attendeeSeed % 15)),
    rating: 4.7,
    ratingCount: 95,
...
export const futureEventsForOneCommunity: EventBasic[] = Array.from(
  { length: 15 },
  (_, index) => createCommunityLightningEvent(
    `future-${index + 1}`,
    3 + index * 4,
    index,
    index,
...
export const pastEventsForOneCommunity: EventBasic[] = Array.from(
  { length: 25 },
  (_, index) => createCommunityLightningEvent(
    `past-${index + 1}`,
    -(3 + index * 7),
    index,
    (index + 2) % COMMUNITY_EVENT_LOCATIONS.length,
  ),
);
...
export const events: EventBasic[] = [
  {
    ...
    location: { label: 'Madrid Palacio', lat: 40.4155, lng: -3.7141 },
  ...
  },
  {
    ...
    location: { label: 'Tropicana', lat: 40.4227, lng: -3.6978 },
  ...
  },
  {
    ...
    location: { label: 'Centro', lat: 40.4168, lng: -3.7038 },
  ...
  },
  {
    ...
    location: { label: 'CentroCentro', lat: 40.4189, lng: -3.6919 },
  ...
  },
  {
    ...
    location: { label: 'Parque del Retiro', lat: 40.4153, lng: -3.6844 },
  ...
  },
  {
    ...
    location: { label: 'Wine Bar', lat: 40.4240, lng: -3.7020 },
...
export const eventsForOneInterest: EventBasic[] = [
  {
    ...
    location: { label: 'Café Comercial', lat: 40.4201, lng: -3.7035 },
  ...
  },
  {
    ...
    location: { label: 'Museo del Prado', lat: 40.4138, lng: -3.6921 },
  ...
  },
  {
    ...
    location: { label: 'Malasaña', lat: 40.4267, lng: -3.7037 },
