export const members = {
  peter: {
    name: 'Peter C',
    img: './assets/dummy-data/member-peter.webp',
  },
  maria: {
    name: 'Maria M',
    img: './assets/dummy-data/member-maria.jpg',
  },
  achi: {
    name: 'Achi J',
    img: './assets/dummy-data/member-achi.avif',
  },
  olivia: {
    name: 'Olivia M',
    img: './assets/dummy-data/member-olivia.jpg',
  },
  caro: {
    name: 'Caro M',
    img: './assets/dummy-data/member-caro.jpg',
  },
  dom: {
    name: 'Dominik',
    img: './assets/dummy-data/member-dom.jpg',
  },
  chloe: {
    name: 'Chloe Dupont',
    img: './assets/dummy-data/member-chloe.jpg',
  },
  lucy: {
    name: 'Lucy Petroski',
    img: './assets/dummy-data/member-lucy.jpg',
  },
  sam: {
    name: 'Sam Harris',
    img: './assets/dummy-data/member-sam.jpg',
  },
};
...
export const communities = {
  freshers: {
    ...
    img: './assets/dummy-data/community-freshers.avif',
    details: `<p>
  ...
  polylogue: {
    ...
    img: './assets/dummy-data/community-polylogue.avif',
    details: `<p>
  ...
  conscious: {
    ...
    img: './assets/dummy-data/community-conscious.avif',
    details: `<p>
  ...
  dance: {
    name: 'Happy Feet',
    img: './assets/dummy-data/community-dance.avif',
    details: `<p>
  ...
  philosophy: {
    ...
    img: './assets/dummy-data/community-philosophy.webp',
    details: `<p>
  ...
  sketch: {
    ...
    img: './assets/dummy-data/community-sketch.avif',
    details: `<p>
...
export const events = {
  lightning: {
    ...
    img: './assets/dummy-data/event-lightning.avif',
  ...
  story: {
    ...
    img: './assets/dummy-data/event-story.avif',
  ...
  circle: {
    ...
    img: './assets/dummy-data/event-circle.avif',
  ...
  sketch: {
    ...
    img: './assets/dummy-data/event-sketch.avif',
  ...
  swing: {
    ...
    img: './assets/dummy-data/event-swing.avif',
